	...
	return (
		<div className="rounded-2xl border border-[var(--line)] bg-[var(--surface)] p-5 sm:p-6">
			...
			<p className="mt-2 text-sm text-[var(--sea-ink-soft)]">
				Upload a <strong>reference</strong> mission (vars, triggers, entities
				you want) and a <strong>target</strong> map to patch. The tool inserts
				reference entities (and matching{" "}
				...
				<code className="text-[11px]">{"{triggers}"}</code> inside the target’s
				Helpers with the reference versions, and renumbers reference entity hex
				ids that collide with the target (remap is applied consistently in vars,
				triggers, entities, and tags). Processing stays in your browser.
			</p>
