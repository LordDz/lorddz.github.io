...
export const npfContentSlides: NpfContentSlide[] = [
	{
		...
		bullets: [
			"Mitt bonusbarn hade det lite känslosamt på fritids",
			"Kände igen mig väldigt mycket från min egen barndom",
			"Gjorde en utredning på Nova för ca 7 månader sen",
		],
		speakerNotes: `Mitt bonusbarn Nova hade det lite känslosamt på fritids, och jag kände igen mig väldigt mycket från min egen barndom.

Jag gjorde en utredning på Nova för ca 7 månader sen. Det var där jag började förstå att det kanske inte bara var "så är vissa barn" – utan att jag sett samma mönster i mig själv.`,
	},
	{
		id: "typer",
		kicker: "ADHD",
...
Kan se mönster och helhet som andra missar.`,
	},
	{
		...
		bullets: [
			...
			"Tappar saker dagligen – sambo och jag ringer varandra för att hitta mobilerna",
...
Träning hjälper utöver detta.`,
	},
	{
		...
		bullets: [
			...
			"Missar mejl – tidsrapportering är svårt",
			"Många utan diagnos blir sjukskrivna, risk för depression",
		],
...
Man missar mejl, tidsrapportering är svårt – vardagssaker som kan bli jobbiga på jobbet.
...
Det kan i många fall leda till depression – och i värsta fall självmord, för man orkar inte leva när något känns fel hela tiden. Det här är allvarligt, inte bara "lite glömsk".`,
	},
	{
		...
		bullets: [
			...
			"Studier: ca 50 % i tech tros ha NPF, i spelutveckling ca 70 %",
